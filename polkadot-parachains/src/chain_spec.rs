...
fn testnet_genesis(
	...
	rococo_parachain_runtime::GenesisConfig {
		...
		axia_xcm: rococo_parachain_runtime::PolkadotXcmConfig {
...
fn statemint_genesis(
	...
	statemint_runtime::GenesisConfig {
		...
		aura_ext: Default::default(),
		parachain_system: Default::default(),
		axia_xcm: statemint_runtime::PolkadotXcmConfig {
			safe_xcm_version: Some(SAFE_XCM_VERSION),
		},
	}
}
...
fn statemine_genesis(
	...
	statemine_runtime::GenesisConfig {
		...
		aura_ext: Default::default(),
		parachain_system: Default::default(),
		axia_xcm: statemine_runtime::PolkadotXcmConfig {
			safe_xcm_version: Some(SAFE_XCM_VERSION),
		},
	}
}
...
fn westmint_genesis(
	...
	westmint_runtime::GenesisConfig {
		...
		aura_ext: Default::default(),
		parachain_system: Default::default(),
		axia_xcm: westmint_runtime::PolkadotXcmConfig {
			safe_xcm_version: Some(SAFE_XCM_VERSION),
		},
	}
}
...
fn canvas_kusama_genesis(
	...
	canvas_kusama_runtime::GenesisConfig {
		...
		aura_ext: Default::default(),
		parachain_system: Default::default(),
		axia_xcm: canvas_kusama_runtime::PolkadotXcmConfig {
			safe_xcm_version: Some(SAFE_XCM_VERSION),
		},
