...
use xcm_config::{AxcLocation, XcmConfig, XcmOriginToTransactDispatchOrigin};
...
pub type AssetsForceOrigin =
	EnsureOneOf<EnsureRoot<AccountId>, EnsureXcm<IsMajorityOfBody<AxcLocation, ExecutiveBody>>>;
